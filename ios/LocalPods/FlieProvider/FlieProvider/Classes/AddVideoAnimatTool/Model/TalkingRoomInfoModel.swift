...
/*: "id" :*/
fileprivate let str_freeData:String = "ID"
...
struct AwardModelType: HandyJSON {
    //: var gid: String!
    var gid: String! // 礼物Id
    //: var price: Int = 0
...
struct FreebeeMeasurable: HandyJSON {
    //: var num: Int?
    var num: Int? /// 数量
    //: var tag: String?
    var tag: String? /// 说明
...
struct AutomaticallyTransformable: HandyJSON {
