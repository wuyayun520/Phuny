...
fileprivate let str_toEffectValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_intimate_send_bg_nor" :*/
fileprivate let str_coverLessTitle:[Character] = ["b","t","n","_","i","n","t","i","m"]
fileprivate let str_equalNameValue:[Character] = ["a","t","e"]
fileprivate let str_secondValue:[Character] = ["_","s","e","n","d","_","b","g","_","n","o","r"]

/*: "Send" :*/
fileprivate let str_resultData:String = "Sendframe list label no"
...
class HeaderReactiveCompatible: ChatView {
    //: typealias SendBlock = () -> Void
    typealias SendBlock = () -> Void
    //: var sendBlock: SendBlock?
    var sendBlock: SendBlock?
    //: var giftData: GrantCellData?
    var giftData: GrantCellData?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_toEffectValue.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var sendBtn: LabelPositionReactiveCompatible = {
        //: let btn = TalkingButton.init()
        let btn = LabelPositionReactiveCompatible()
        //: btn.setBackgroundImage(UIImage.nearTap(name: "btn_intimate_send_bg_nor"), for: .normal)
        btn.setBackgroundImage(UIImage.nearTap(name: (String(str_coverLessTitle) + String(str_equalNameValue) + String(str_secondValue))), for: .normal)
        ...
        btn.addTarget(self, action: #selector(indexExit), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension HeaderReactiveCompatible {
    ...
    override func fill(with data: TCommonCellData) {
        ...
        self.indicator.stopAnimating()
        //: self.giftData = data as? GrantCellData
        self.giftData = data as? GrantCellData
