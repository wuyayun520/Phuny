...
fileprivate let str_tapUserLetTitle:[UInt8] = [0x21,0x26,0x21,0x2c,0xe0,0x1b,0x27,0x1c,0x1d,0x2a,0xf2,0xe1,0xd8,0x20,0x19,0x2b,0xd8,0x26,0x27,0x2c,0xd8,0x1a,0x1d,0x1d,0x26,0xd8,0x21,0x25,0x28,0x24,0x1d,0x25,0x1d,0x26,0x2c,0x1d,0x1c]

fileprivate func shareName(value num: UInt8) -> UInt8 {
...
/*: "all" :*/
fileprivate let str_makeQuoteData:[Character] = ["a","l","l"]
...
class InvisibleMsgCell: ChatView {
    //: var giftData: KeyCompartmentCellData?
    var giftData: KeyCompartmentCellData?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_tapUserLetTitle.map{shareName(value: $0)}, encoding: .utf8)!)
    }
...
extension InvisibleMsgCell {
    //: override func fill(with data: TCommonCellData) {
    override func fill(with data: TCommonCellData) {
        //: super.fill(with: data)
        super.fill(with: data)
        //: self.giftData = data as? KeyCompartmentCellData
        self.giftData = data as? KeyCompartmentCellData
        ...
        if giftData.msgModel.toUser.uid == "all" { // 送礼所有人
            //: self.toUserImgView.image = UIImage.nearTap(name: giftData.msgModel.toUser.headPic)
            self.toUserImgView.image = UIImage.nearTap(name: giftData.msgModel.toUser.headPic)
            //: } else {
        } else {
            //: self.toUserImgView.setUrlImage(urlStr: giftData.msgModel.toUser.headPic)
            self.toUserImgView.underPause(urlStr: giftData.msgModel.toUser.headPic)
        }
    }
