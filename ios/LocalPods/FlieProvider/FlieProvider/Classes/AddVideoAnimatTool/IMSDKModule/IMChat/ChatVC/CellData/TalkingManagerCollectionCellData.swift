...
/*: _" :*/
fileprivate let str_yearTitle:[Character] = ["_"]

/*: ".png" :*/
fileprivate let str_pathWithBlockText:String = ".pngline text manager source cell"
...
// __CLOSE_PRINT__
//
//  TalkingManagerCollectionCellData.swift
//  AbroadTalking
//
...
//: @objcMembers public class TalkingManagerCollectionCellData: TalkingChatMsgBaseCellData {
@objcMembers public class TalkingManagerCollectionCellData: MakeCellData {
    ...
    override public var msgModel: LockModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.beginTap(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func appearImageMake(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(consLet_callTitle)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + IndexStyleAppManager.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + IndexStyleAppManager.share.loginUserMode.userID + ".png"
        ...
        let imageData = UIImage.key(image, handleCover: 2 * 1024)
