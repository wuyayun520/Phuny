...
/*: "CCCCCC" :*/
fileprivate let str_dailyValue:[Character] = ["C","C","C","C","C","C"]

/*: "icon_lounge" :*/
fileprivate let str_videoMomentData:[Character] = ["i","c","o","n","_","l","o","u","n"]
fileprivate let str_appData:[Character] = ["g","e"]

/*: "#FFEE4B" :*/
fileprivate let str_viewName:[Character] = ["#","F","F","E","E","4"]
fileprivate let str_whiteName:[Character] = ["B"]

/*: "View read receipts?" :*/
fileprivate let str_arrayPathTitle:[Character] = ["V","i","e","w"," ","r","e","a","d"," ","r","e","c","e"]
fileprivate let str_priceData:String = "a limit corner view feedipts?"

/*: "#FBE3FE" :*/
fileprivate let str_imageBackModelValue:[Character] = ["#","F","B","E","3","F","E"]

/*: "#D8DDFF" :*/
fileprivate let str_contentTitle:[Character] = ["#","D"]
fileprivate let str_frameTitle:String = "8DDFFmodel view"
...
class PrizeMsgCell: ChatView {
    ...
    private lazy var vipReadReceiptBtn: LabelPositionReactiveCompatible = {
        //: let btn = TalkingButton()
        let btn = LabelPositionReactiveCompatible()
        //: btn.setImage(UIImage.nearTap(name: "icon_lounge"), for: .normal)
        btn.setImage(UIImage.nearTap(name: (String(str_videoMomentData) + String(str_appData))), for: .normal)
        ...
        btn.setTitle((String(str_arrayPathTitle) + String(str_priceData.suffix(5))).localized, for: .normal)
        ...
        btn.addTarget(self, action: #selector(skimOverAcross), for: .touchUpInside)
        ...
        let gColor = [UIColor(hex: "#FBE3FE")!.withAlphaComponent(0.6).cgColor,
        ...
        btn.setBackgroundImage(UIImage.onCornerTo(colors: gColor, size: CGSize(width: btnWidth, height: btnHeight)), for: .normal)
...
extension PrizeMsgCell {
    /// vip订阅事件
    //: @objc private func vipReadReceiptClick() {
    @objc private func skimOverAcross() {
...
extension PrizeMsgCell {
    ...
    override func fill(with data: TCommonCellData) {
        ...
        if dataLayout != nil {
            ...
            //: let layout = YYTextLayout.init(containerSize: CGSize.init(width: OverdoReactiveCompatible.getScreenWidth()-50, height: CGFloat(MAXFLOAT)), text: tipCellData.attributedString)
            let layout = YYTextLayout(containerSize: CGSize(width: OverdoReactiveCompatible.observerReason() - 50, height: CGFloat(MAXFLOAT)), text: tipCellData.attributedString)
        ...
        if tipCellData.msgModel.tips.content == (String(str_arrayPathTitle) + String(str_priceData.suffix(5))).localized {
    ...
    override func updateConstraints() {
        ...
        self.container.snp.remakeConstraints { make in
            ...
            make.width.lessThanOrEqualTo(consLet_errorDeviceHeightData - 40)
            //: make.top.equalTo(10)
            make.top.equalTo(10)
    ...
    func withStyle() {
        ...
        let containerTap = UITapGestureRecognizer(target: self, action: #selector(toTap(tap:)))
    ...
    @objc func toTap(tap _: UITapGestureRecognizer) {
