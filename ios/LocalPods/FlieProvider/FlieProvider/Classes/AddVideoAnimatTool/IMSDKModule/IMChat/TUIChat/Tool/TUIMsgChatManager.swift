...
//
//        let userDic = ["uid":IndexStyleAppManager.share.loginUserMode.userID,"nickName":IndexStyleAppManager.share.loginUserMode.nickname,"headPic":IndexStyleAppManager.share.loginUserMode.headPic,"mbId":msgInfo["mbId"]]
...
//
//        if msgTypeStr == "gift" {
//            let cellData = AbCellData.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try LockModel.init(dictionary: tempDic)
...
//
//            let cellData = BackgroundLabelCellData.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try LockModel.init(dictionary: tempDic)
...
//            let cellData = TalkingManagerCollectionCellData.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try LockModel.init(dictionary: tempDic)
...
//            let cellData = ClearCellData.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try LockModel.init(dictionary: tempDic)
