...
@objcMembers public class TalkingSystemMsgCellData: TUIMessageCellData {
    ...
    var contentFont = UIFont.exceptEqual(fontSize: 13)
    var contentColor = UIColor.bringHomeColor()
    ...
    public override func contentSize() -> CGSize {
        let textSize = CGSize(width: consLet_errorDeviceHeightData/2, height: consLet_sessionName)
