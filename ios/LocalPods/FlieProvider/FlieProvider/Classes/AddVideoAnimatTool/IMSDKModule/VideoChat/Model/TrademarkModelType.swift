...
let consLet_saveName = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let consLet_recordName = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let consLet_barText = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct TrademarkModelType: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
