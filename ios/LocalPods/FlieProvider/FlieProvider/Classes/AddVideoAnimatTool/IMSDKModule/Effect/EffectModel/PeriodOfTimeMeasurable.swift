...
/*: "id" :*/
fileprivate let str_addData:[Character] = ["i","d"]

/*: "num" :*/
fileprivate let str_faceInfoTitle:String = "nsharem"
...
@objc public enum HalfColumnConvertible: Int {
    //: case normal  = 1
    case normal = 1 // 普通礼物
    //: case myStery = 2
    case myStery = 2 // 盲盒礼物
...
struct PeriodOfTimeMeasurable: HandyJSON {
    //: init() {
    init() {}
    ...
    var animationTimes = 0
    //: var showType = 0
    var showType = 0 /// HalfColumnConvertible
    ...
    mutating func titlePoint(giftNum: Int) {
        //: self.num = giftNum
        self.num = giftNum
    }
}
...
struct ItemHandyJSON: HandyJSON {
    //: init() {
    init() {}
