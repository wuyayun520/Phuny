...
/*: "App" :*/
fileprivate let str_appName:String = "Appopen frame create wrap"

/*: "blockList_ :*/
fileprivate let str_recordName:[Character] = ["b","l","o","c"]
fileprivate let str_viewData:String = "equal appkList_"
...
class MonthThen: NSObject {
    ...
    func dataConverterRoom(userId: String) {
    ...
    func nameIcon(userId: String) -> Bool {
    ...
    private func border() -> String {
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(str_recordName) + String(str_viewData.suffix(6))) + "\(uid)")
        //: return filePath
        return filePath
    }
}
