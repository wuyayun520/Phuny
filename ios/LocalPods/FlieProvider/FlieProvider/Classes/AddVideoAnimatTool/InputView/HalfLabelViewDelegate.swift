...
fileprivate let str_succeedTableText:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "#292929" :*/
fileprivate let str_videoTitle:[Character] = ["#","2","9","2","9","2"]
fileprivate let str_contentRestoreData:String = "9"

/*: "9999999" :*/
fileprivate let str_viewName:[Character] = ["9","9","9","9","9","9","9"]

/*: "icon_coin" :*/
fileprivate let str_giftName:String = "click table forward coloricon_"
fileprivate let str_modelTitle:String = "cdayin"

/*: "icon_gift_more_arrow" :*/
fileprivate let str_dataValue:String = "icon_interval if make on"
fileprivate let str_indexValue:String = "re_arrowclick make leading name extra"

/*: "PackageEqualThen" :*/
fileprivate let str_appValue:String = "model bag equalTalk"
fileprivate let str_tempContent:String = "content read view freshckageG"
fileprivate let str_objectValue:String = "gift online infoiftCell"

/*: "Hot" :*/
fileprivate let str_toValue:String = "target shared model var cellHot"

/*: "VIP" :*/
fileprivate let str_unknownName:[Character] = ["V","I","P"]

/*: "Bags" :*/
fileprivate let str_currentData:String = "Bagsdesign index"

/*: "icon_gift_num_arrow" :*/
fileprivate let str_needValue:String = "icon_public raw lab search text"
fileprivate let str_mainAddName:String = "task"
fileprivate let str_userIndexTitle:[Character] = ["n","u","m","_","a","r","r","o","w"]

/*: "Send" :*/
fileprivate let str_colorSpaceName:String = "button make viewSend"

/*: "nav_back_black_nor" :*/
fileprivate let str_statusValue:String = "let enable var labnav_"
fileprivate let str_sightEventName:[Character] = ["b","a","c","k","_","b","l","a","c","k","_","n","o","r"]

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let str_refuseData:[UInt8] = [0xc2,0xd6,0xd3,0x8e,0xdc,0xe3,0xdb,0xd0,0xd3,0xe0,0x8e,0xdd,0xd4,0x8e,0xd5,0xd7,0xd4,0xe2,0xe1,0x8e,0xd1,0xcf,0xdc,0xdc,0xdd,0xe2,0x8e,0xd0,0xd3,0x8e,0xda,0xd3,0xe1,0xe1,0x8e,0xe2,0xd6,0xcf,0xdc,0x8e,0x9f]

fileprivate func bidLength(equal num: UInt8) -> UInt8 {
...
fileprivate let str_shadeData:[Character] = ["P","l","e","a","s","e"," ","s","e","l","e","c","t"," ","a"," ","g","i"]
fileprivate let str_userName:[Character] = ["f","t"]

/*: "Please select an object" :*/
fileprivate let str_upName:String = "Pleasmake app"
fileprivate let str_videoPathContent:String = "gesture"
fileprivate let str_bottomText:[Character] = ["c","t"," ","a","n"," ","o","b","j","e","c","t"]

/*: "Select the desired gift to unlock" :*/
fileprivate let str_constraintText:[UInt8] = [0x6b,0x63,0x6f,0x6c,0x6e,0x75,0x20,0x6f,0x74,0x20,0x74,0x66,0x69,0x67,0x20,0x64,0x65,0x72,0x69,0x73,0x65,0x64,0x20,0x65,0x68,0x74,0x20,0x74,0x63,0x65,0x6c,0x65,0x53]

/*: "OK" :*/
fileprivate let str_upValue:String = "succeed"

/*: "Select object >" :*/
fileprivate let str_coverData:[Character] = ["S","e","l","e","c","t"," "]
fileprivate let str_winnerData:String = "indicator any live let sinceobject >"

/*: "It looks like there's nothing" :*/
fileprivate let str_arrayMoreTitle:String = "self room data in labelIt "
fileprivate let str_closeTitle:[Character] = ["l","o","o","k","s"," ","l","i","k","e"," ","t","h","e","r","e","\'","s"," ","n","o","t","h","i","n","g"]

/*: "FF75A4" :*/
fileprivate let str_viewClickSocialData:String = "stylestyle75A4"

/*: "E570FF" :*/
fileprivate let str_hiddenValue:String = "E5count0FF"

/*: "Ask for" :*/
fileprivate let str_challengeName:[Character] = ["A","s","k"," ","f"]
fileprivate let str_managerName:[Character] = ["o","r"]

/*: " Select %@ > " :*/
fileprivate let str_assetWhiteTitle:String = " Seleadd add out self false"
fileprivate let str_cameraName:String = "@ > "

/*: "All Numbers" :*/
fileprivate let str_buttonName:[Character] = ["A","l","l"," ","N","u","m","b","e","r","s"]

/*: "View detailed description >" :*/
fileprivate let str_numberTitle:String = "status bottom return withView d"
fileprivate let str_centerNeedValue:String = "view class viewled "
fileprivate let str_publishMessageText:String = "datasc"
fileprivate let str_withValue:String = "ription >class index"

/*: "\n" :*/
fileprivate let str_progressData:String = "\n"

/*: "%.2f" :*/
fileprivate let str_modelName:String = "return back string color icon%.2f"

/*: "9999" :*/
fileprivate let str_skipLabelText:String = "9999"

/*: "Custom" :*/
fileprivate let str_colorData:String = "let toCustom"

/*: "mf_coin" :*/
fileprivate let str_sharedValue:[Character] = ["m","f","_","c","o","i"]
fileprivate let str_makeName:[Character] = ["n"]

/*: "showBagsRed" :*/
fileprivate let str_shareName:[Character] = ["s","h","o","w","B"]
fileprivate let str_timeName:String = "label"
fileprivate let str_playName:String = "gsRedbackground image"
...
typealias SendFunctionBlock = (_ giftModel: AwardModelType, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: AwardModelType, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: AwardModelType) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: AwardModelType, _ num: String, _ model: TotalensityMemberModel) -> Void
// 隐藏礼物面板Block
...
private let consLet_cellValue = 44.0
//: let GiftScrollContentView_H = 252.0
let consLet_itemData = 252.0
//: private let pageControl_H = 7.0
private let consLet_controlName = 7.0
//: private let bottomView_H = 44.0
private let consLet_fileText = 44.0

//: class TalkingChatGiftView: UIView {
class HalfLabelViewDelegate: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = consLet_cellValue + consLet_itemData + consLet_controlName + consLet_fileText + consLet_halfTitle
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var titlesArr = [OverdoPriorityTarget]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = OverdoPriorityTarget.Hot
    ...
    init(frame: CGRect = .zero, style: JumpBasicType = .normal, titlesArr: [OverdoPriorityTarget] = [.Hot, .Vip, .Bags]) {
        ...
        if self.style == .party {
            ...
            contentHeight += consLet_useValue
        }
        //: setupSubviews()
        hockeyPlayer()
        //: bindInteraction()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_succeedTableText.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: consLet_sessionName, width: consLet_errorDeviceHeightData, height: contentHeight)
        ...
        content.toColorRadii(width: consLet_errorDeviceHeightData, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    lazy var partyIconView: DarkroomView = {
        //: let frame = CGRect(x: 0, y: 0, width: ScreenWidth, height: TalkingVoiceRoomIconGiftView_H)
        let frame = CGRect(x: 0, y: 0, width: consLet_errorDeviceHeightData, height: consLet_useValue)
        //: let view = TalkingVoiceRoomIconGiftView(frame: frame)
        let view = DarkroomView(frame: frame)
        //: view.isHidden = true
        view.isHidden = true
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: consLet_errorDeviceHeightData, height: consLet_cellValue)
    ...
    private lazy var moneyBtn: LabelPositionReactiveCompatible = {
        //: let btn = TalkingButton()
        let btn = LabelPositionReactiveCompatible()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.loadEnable(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.loadEnable(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle("9999999", for: .normal)
        //: btn.setImage(UIImage.nearTap(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.nearTap(name: (String(str_giftName.suffix(5)) + str_modelTitle.replacingOccurrences(of: "day", with: "o"))), for: .normal)
    ...
    private lazy var rechargeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(behindTableUp), for: .touchUpInside)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        let img = UIImageView()
        //: img.image = UIImage.nearTap(name: "icon_gift_more_arrow")
        img.image = UIImage.nearTap(name: (String(str_dataValue.prefix(5)) + "gift_mo" + String(str_indexValue.prefix(8))))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.computeImage(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.computeImage(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        //: hot.isHidden = false
        hot.isHidden = false
        //: hot.register(TalkingPackageGiftCell.self, forCellWithReuseIdentifier: "TalkingPackageGiftCell")
        hot.register(PackageEqualThen.self, forCellWithReuseIdentifier: (String(str_appValue.suffix(4)) + "ingPa" + String(str_tempContent.suffix(6)) + String(str_objectValue.suffix(7))))
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: EventGiftLayout = //: return hotGiftCollectionView.collectionViewLayout as! EventGiftLayout
        hotGiftCollectionView.collectionViewLayout as! EventGiftLayout
    //: }()
    ...
    private lazy var titleScrollView: ColorReactiveCompatible = {
        //: var titles = [String]()
        var titles = [String]()
        //: titlesArr.forEach { type in
        for type in titlesArr {
            //: switch type {
            switch type {
            //: case .Hot:
            case .Hot:
        ...
        var style = RowMonthSegmentStyle()
        ...
        let scrollview = ColorReactiveCompatible(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(consLet_cellValue)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if ServerLanguageManager.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = OverdoReactiveCompatible.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = OverdoReactiveCompatible.observerReason() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !RoomGiftManager.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var sendAreaView: UIView = {
        ...
        view.layer.borderColor = UIColor.labelSumervalMedium().cgColor
    ...
    private lazy var giftNumButton: LabelPositionReactiveCompatible = {
        ...
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setImage(UIImage.nearTap(name: "icon_gift_num_arrow"), for: .normal)
        btn.setImage(UIImage.nearTap(name: (String(str_needValue.prefix(5)) + "gift" + str_mainAddName.replacingOccurrences(of: "task", with: "_") + String(str_userIndexTitle))), for: .normal)
        //: btn.imageAlignment = .right
        btn.imageAlignment = .right
        //: btn.spaceBetweenTitleAndImage = 4
        btn.spaceBetweenTitleAndImage = 4
        //: btn.addTarget(self, action: #selector(giftNumBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(portionClickSave), for: .touchUpInside)
    ...
    private lazy var sendButton: UIButton = {
        //: let btn = UIButton.init()
        let btn = UIButton()
        //: btn.titleLabel?.font = UIFont.loadEnable(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.loadEnable(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.labelSumervalMedium()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle("Send".localized, for: .normal)
        //: btn.addTarget(self, action: #selector(onTouchSendGiftBtn), for: .touchUpInside)
        btn.addTarget(self, action: #selector(dower), for: .touchUpInside)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: consLet_sessionName - CGFloat(keyborHeight) - 44, width: consLet_errorDeviceHeightData, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.nearTap(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.nearTap(name: (String(str_statusValue.suffix(4)) + String(str_sightEventName))).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.fullMoon(color: .labelSumervalMedium(), forState: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.noblesseExtra(showMsg: String(bytes: str_refuseData.map{bidLength(equal: $0)}, encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.noblesseExtra(showMsg: (String(str_shadeData) + String(str_userName)).localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.noblesseExtra(showMsg: (String(str_upName.prefix(5)) + "e sel" + str_videoPathContent.replacingOccurrences(of: "gesture", with: "e") + String(str_bottomText)).localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = OverdoPriorityTarget(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.clip(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: AwardModelType = dataArr[index] as! AwardModelType
    ...
    private lazy var giftInputNameLabel: UILabel = {
        ...
        lb.textColor = UIColor.labelSumervalMedium()
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(selectRemove(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(small(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(roomModelAdd(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: str_constraintText.reversed(), encoding: .utf8)!.localized
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(str_coverData) + String(str_winnerData.suffix(8))).localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
        ...
        btn.addTarget(self, action: #selector(counteractionOn), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var blindBoxExplainBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(requestUser), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        //: lab.textColor = .white
        lab.textColor = .white
        //: lab.font = UIFont.loadEnable(type: .Regular, fontSize: 16)
        lab.font = UIFont.loadEnable(type: .Regular, fontSize: 16)
        //: lab.text = "It looks like there's nothing".localized
        lab.text = (String(str_arrayMoreTitle.suffix(3)) + String(str_closeTitle)).localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.onCornerTo(colors: [UIColor(hex: "FF75A4")!.cgColor, UIColor(hex: "E570FF")!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.loadEnable(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.loadEnable(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
...
extension HalfLabelViewDelegate {
    /// 隐藏视图
    ...
    @objc func viewDrop() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: consLet_sessionName, width: consLet_errorDeviceHeightData, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    func viewEnable() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.contentView.frame = CGRect(x: 0, y: consLet_sessionName - self.contentHeight, width: consLet_errorDeviceHeightData, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func holdfast() {
        ...
        guard let dataType = OverdoPriorityTarget(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.clip(dataType: dataType)
    ...
    @objc func counteractionOn() {
        //: meneView = DropDownMemberMenuView.init(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
        meneView = StepMenuView(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func requestUser() {
        //: dismissView()
        viewDrop()
        //: PostPushManager.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        PostPushManager.share.scene(webViewType: .luckyBlindBox)
    }
...
extension HalfLabelViewDelegate {
    ...
    func fastening(pkgItemsetId: String, num: Int) {
        ...
        DispatchQueue.main.async {
            ...
            RoomGiftManager.share.startPhoto(dataType: self.currType, dataArr: bagsDataArr)
            ...
            self.drunkCountForce(force: true)
        }
    }
}

// MARK: - KeyStableViewDelegate

//: extension TalkingChatGiftView: DropDownMemberMenuViewDelegate {
extension HalfLabelViewDelegate: KeyStableViewDelegate {
    //: func didClickSelectedRow(model: TalkingChatRoomMemberModel) {
    func notBuild(model: TotalensityMemberModel) {
    ...
    func messageMembers() {
        ...
        if model.nickname == (String(str_buttonName)).localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! TotalensityMemberModel
    ...
    func setsetTitle(title: String) {
        //: let str = "View detailed description >".localized
        let str = (String(str_numberTitle.suffix(6)) + "etai" + String(str_centerNeedValue.suffix(4)) + str_publishMessageText.replacingOccurrences(of: "data", with: "de") + String(str_withValue.prefix(9))).localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension HalfLabelViewDelegate: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func clip(dataType: OverdoPriorityTarget) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return RoomGiftManager.share.giftViewType(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func largessItems() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return RoomGiftManager.share.momentDown()
    }
    ...
    func lifeStyle(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == VersionSendable.myStery.rawValue)
        }
    ...
    @objc func roomModelAdd(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: consLet_sessionName - CGFloat(keyborHeight) - 44, width: consLet_errorDeviceHeightData, height: 44)
    }

    //: @objc func keyboardWillBeHidden(notification: NSNotification) {
    @objc func small(notification _: NSNotification) {
    ...
    func deleteField() {
        ...
        let sendingItems = largessItems()
        //: var titleArray = Array<String>()
        var titleArray = [String]()
        //: for i in 1..<sendingItems.count {
        for i in 1 ..< sendingItems.count {
            //: let text = String(numberOfGiftForIndex(index: i))
            let text = String(finish(index: i))
//            let giftNumArrModel: FreebeeMeasurable = sendingItems[i] as! FreebeeMeasurable
//            text += "  " + (giftNumArrModel.tag ?? "")
        ...
        Config.OrientationConfig.menuCellHeight = 40

        //: let dropMenu = DropDownMenuView.pullDropDrownMenu(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
        let dropMenu = SequenceDataSource.spectrumArray(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
    ...
    func anEqual() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? PackageEqualThen
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.eliteAll(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = OverdoPriorityTarget(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = clip(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        //: let identifier = "TalkingPackageGiftCell"
        let identifier = (String(str_appValue.suffix(4)) + "ingPa" + String(str_tempContent.suffix(6)) + String(str_objectValue.suffix(7)))
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! PackageEqualThen
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = OverdoPriorityTarget(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = clip(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: AwardModelType = dataArr[indexPath.row] as! AwardModelType
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.following(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.inform(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = OverdoPriorityTarget(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = clip(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == VersionSendable.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == VersionSendable.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: PackageEqualThen = giftSelectedModel.lastHotCell as! PackageEqualThen
                //: cell.setChecked(checked: false)
                cell.inform(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: PackageEqualThen = self.hotGiftCollectionView.cellForItem(at: indexPath) as! PackageEqualThen
            //: currentCell.setChecked(checked: true)
            currentCell.inform(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.full(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.clip(dataType: self.currType)
    ...
    func drunkCountForce(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + consLet_errorDeviceHeightData
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < consLet_errorDeviceHeightData ? consLet_errorDeviceHeightData : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / consLet_errorDeviceHeightData - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(consLet_errorDeviceHeightData) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = OverdoPriorityTarget.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = RoomGiftManager.share.needAcross(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.cameraAnimate(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && IndexStyleAppManager.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == OverdoPriorityTarget.Hot && self.style == .normal && IndexStyleAppManager.share.loginUserMode.sex == ColorExpressionConvertible.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == VersionSendable.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                setsetTitle(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func highSociety() {
        //: self.giftSelectedModel = TalkingGiftSelectedModel()
        self.giftSelectedModel = AutomaticallyTransformable()
...
extension HalfLabelViewDelegate: StoreViewDelegate {
    ...
    func star(index: Int, title: String) {
        ...
        pathRow(index: index + 1, title: title)
    }

    //: func  didClickSelectedCellRow(index: Int, title: String) {
    func pathRow(index: Int, title _: String) {
        //: let numberOfGift = numberOfGiftForIndex(index: index)
        let numberOfGift = finish(index: index)
        //: if numberOfGift>0 {
        if numberOfGift > 0 {
            ...
            popView?.straddleView(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.loadExecute(view: self.window!)
    ...
    func finish(index: Int) -> Int {
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: FreebeeMeasurable = sendingItems[index] as! FreebeeMeasurable
    ...
    func colorNum(num: Int) -> Int {
        //: var index = 0
        var index = 0
        //: for i in 0..<giftSendItems().count {
        for i in 0 ..< largessItems().count {
            //: let model: TalkingGiftNumArrModel = giftSendItems()[i] as! TalkingGiftNumArrModel
            let model: FreebeeMeasurable = largessItems()[i] as! FreebeeMeasurable
            //: if model.num == num {
            if model.num == num {
                //: break
                break
    ...
    func viewer(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > largessItems().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension HalfLabelViewDelegate {
    ...
    private func hockeyPlayer() {
        //: self.backgroundColor = UIColor.clear
        self.backgroundColor = UIColor.clear
        //: let tagView = UIView.init(frame: CGRect(x: 0, y: 0, width: ScreenWidth, height: ScreenHeight-contentHeight))
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: consLet_errorDeviceHeightData, height: consLet_sessionName - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(viewDrop)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(consLet_itemData)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(consLet_errorDeviceHeightData)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(consLet_errorDeviceHeightData - 10)
        }
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(consLet_controlName)
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(consLet_fileText)
        }
    ...
    private func range() {
        //: IndexStyleAppManager.share.loginUserMode.rx
        IndexStyleAppManager.share.loginUserMode.rx
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.lifeStyle(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        RoomGiftManager.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(str_shareName) + str_timeName.replacingOccurrences(of: "label", with: "a") + String(str_playName.prefix(5))))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                RoomGiftManager.share.indexMake(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: IndexStyleAppManager.share.loginUserMode.mf_coin)
                    self.lifeStyle(needReload: true, mf_coin: IndexStyleAppManager.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })
