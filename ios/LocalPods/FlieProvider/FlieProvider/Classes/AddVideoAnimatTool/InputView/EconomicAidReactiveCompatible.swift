...
// __CLOSE_PRINT__
//
//  EconomicAidReactiveCompatible.swift
//  AbroadTalking
//
...
open class EconomicAidReactiveCompatible: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = EconomicAidReactiveCompatible.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
    ...
    private func callOf() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(installmentLess),
    ...
    @objc private func installmentLess() {
