...
fileprivate let str_bagValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "bg_medals_podium" :*/
fileprivate let str_arrayName:[Character] = ["b","g","_","m","e","d","a","l"]
fileprivate let str_giftValue:String = "in label model videos_podium"

/*: "icon_rank_first_bg" :*/
fileprivate let str_textShareName:String = "icon_renable interval in for talk"
fileprivate let str_addValue:String = "make any equalfirst_bg"

/*: "icon_rank_first" :*/
fileprivate let str_sharedTitle:String = "icon_rimage image height edit group"
fileprivate let str_giftBecomeValue:[Character] = ["a","n","k","_","f","i","r","s","t"]

/*: "icon_ammount_points" :*/
fileprivate let str_titleValue:[Character] = ["i","c","o","n","_","a"]
fileprivate let str_lockTitle:String = "messageount"
fileprivate let str_hiddenValue:[Character] = ["_","p","o","i","n","t","s"]

/*: "icon_lounge" :*/
fileprivate let str_frameData:String = "icnormal"

/*: "icon_rank_coin" :*/
fileprivate let str_allData:[Character] = ["i","c","o","n","_","r","a","n","k","_","c","o","i","n"]

/*: "icon_rank_coin2" :*/
fileprivate let str_modeData:String = "status selficon_r"
fileprivate let str_createData:String = "ank_coin2as status leading to"

/*: "icon_rank_second" :*/
fileprivate let str_resultViewTitle:[Character] = ["i","c","o","n","_","r","a","n","k","_","s","e","c","o","n","d"]

/*: "icon_rank_third" :*/
fileprivate let str_networkValue:[Character] = ["i"]
fileprivate let str_videoName:[Character] = ["c","o","n","_","r","a","n","k","_","t","h","i","r","d"]
...
class BlockView: UIView {
    ...
    var dataArray: [SickbayModelType] = [] {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_bagValue.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var medalsView = UIImageView().then {
        //: $0.image = UIImage.nearTap(name: "bg_medals_podium")
        $0.image = UIImage.nearTap(name: (String(str_arrayName) + String(str_giftValue.suffix(8))))
    }

    //: lazy var firstView = SocialRankHeaderItemView.init(frame: .zero, rankType: .firstRankType).then {
    lazy var firstView = ItemReactiveCompatible(frame: .zero, rankType: .firstRankType).then {
        //: $0.backgroundColor = .clear
        $0.backgroundColor = .clear
        //: $0.tag = 0
        $0.tag = 0
        //: let tap = UITapGestureRecognizer.init(target: self, action: #selector(registTapAction))
        let tap = UITapGestureRecognizer(target: self, action: #selector(statusGift))
        //: $0.addGestureRecognizer(tap)
        $0.addGestureRecognizer(tap)
    }

    //: lazy var secondView = SocialRankHeaderItemView.init(frame: .zero, rankType: .secondRankType).then {
    lazy var secondView = ItemReactiveCompatible(frame: .zero, rankType: .secondRankType).then {
        //: $0.backgroundColor = .clear
        $0.backgroundColor = .clear
        //: $0.tag = 1
        $0.tag = 1
    ...
    lazy var thirdView = ItemReactiveCompatible(frame: .zero, rankType: .thirdRankType).then {
        //: $0.backgroundColor = .clear
        $0.backgroundColor = .clear
        //: $0.tag = 2
        $0.tag = 2
...
extension BlockView {
    ...
    private func sinceContent() {
        //: let firstWidth = (ScreenWidth - actualWidth(w: 68)) / 3 + actualWidth(w: 10)
        let firstWidth = (consLet_errorDeviceHeightData - actualWidth(w: 68)) / 3 + actualWidth(w: 10)
        //: let itemWidth = (ScreenWidth - actualWidth(w: 68)) / 3 - actualWidth(w: 10)
        let itemWidth = (consLet_errorDeviceHeightData - actualWidth(w: 68)) / 3 - actualWidth(w: 10)
...
class ItemReactiveCompatible: UIView {
    ...
    public init(frame: CGRect, rankType: LineService) {
        //: super.init(frame: frame)
        super.init(frame: frame)
        //: self.setupItemViews(type: rankType)
        self.enableDoingline(type: rankType)
    }
    ...
    lazy var headPicBgView = UIImageView().then {
        //: $0.image = UIImage.nearTap(name: "icon_rank_first_bg")
        $0.image = UIImage.nearTap(name: (String(str_textShareName.prefix(6)) + "ank_" + String(str_addValue.suffix(8))))
    }
    ...
    lazy var crownImgView = UIImageView().then {
        //: $0.image = UIImage.nearTap(name: "icon_rank_first")
        $0.image = UIImage.nearTap(name: (String(str_sharedTitle.prefix(6)) + String(str_giftBecomeValue)))
    }
    ...
    lazy var nickLabel = UILabel().then {
        //: $0.textColor = .white
        $0.textColor = .white
        //: $0.font = .loadEnable(type: .Medium, fontSize: 18)
        $0.font = .loadEnable(type: .Medium, fontSize: 18)
    ...
    lazy var coinButton = LabelPositionReactiveCompatible().then {
        //: $0.isUserInteractionEnabled = false
        $0.isUserInteractionEnabled = false
        //: $0.setImage(UIImage.nearTap(name: "icon_ammount_points"), for: .normal)
        $0.setImage(UIImage.nearTap(name: (String(str_titleValue) + str_lockTitle.replacingOccurrences(of: "message", with: "mm") + String(str_hiddenValue))), for: .normal)
        //: $0.titleLabel?.font = .loadEnable(type: .Regular, fontSize: 13)
        $0.titleLabel?.font = .loadEnable(type: .Regular, fontSize: 13)
    ...
    lazy var loungeImgV = UIImageView().then {
        ...
        $0.image = UIImage.nearTap(name: (str_frameData.replacingOccurrences(of: "normal", with: "on") + "_lounge"))
    }
}
...
extension ItemReactiveCompatible {
    ...
    func behindPush(model: SickbayModelType?, type: Int) {
        ...
        headPic.cling(urlStr: model!.headPic, placeImg: UIImage.numericalQuantityTheme(sex: model!.sex))
        ...
        //: if type == 0 {
        if type == 0 {
            //: coinButton.setImage(UIImage.nearTap(name: "icon_rank_coin"), for: .normal)
            coinButton.setImage(UIImage.nearTap(name: (String(str_allData))), for: .normal)
            //: } else {
        } else {
            //: coinButton.setImage(UIImage.nearTap(name: "icon_rank_coin2"), for: .normal)
            coinButton.setImage(UIImage.nearTap(name: (String(str_modeData.suffix(6)) + String(str_createData.prefix(9)))), for: .normal)
        }
    }
}
...
extension ItemReactiveCompatible {
    ...
    func enableDoingline(type: LineService) {
...
//        var topCrownMargin = actualHeight(h: 4)
        ...
        case .firstRankType:
            ...
            headPicBgView.isHidden = false
            //: crownImgView.image = UIImage.nearTap(name: "icon_rank_first")
            crownImgView.image = UIImage.nearTap(name: (String(str_sharedTitle.prefix(6)) + String(str_giftBecomeValue)))
            //: headPic.layer.borderColor = UIColor.RGBA(255, 224, 58, 1).cgColor
            headPic.layer.borderColor = UIColor.computeImage(255, 224, 58, 1).cgColor
...
//            topCrownMargin = actualHeight(h: 10)
        ...
        case .secondRankType:
            ...
            headPicBgView.isHidden = true
            //: crownImgView.image = UIImage.nearTap(name: "icon_rank_second")
            crownImgView.image = UIImage.nearTap(name: (String(str_resultViewTitle)))
            //: headPic.layer.borderColor = UIColor.RGBA(182, 199, 254, 1).cgColor
            headPic.layer.borderColor = UIColor.computeImage(182, 199, 254, 1).cgColor
        ...
        case .thirdRankType:
            //: headPicBgView.isHidden = true
            headPicBgView.isHidden = true
            //: crownImgView.image = UIImage.nearTap(name: "icon_rank_third")
            crownImgView.image = UIImage.nearTap(name: (String(str_networkValue) + String(str_videoName)))
            //: headPic.layer.borderColor = UIColor.RGBA(251, 166, 109, 1).cgColor
            headPic.layer.borderColor = UIColor.computeImage(251, 166, 109, 1).cgColor
            //: headPic.layer.cornerRadius = actualWidth(w: 31)
            headPic.layer.cornerRadius = actualWidth(w: 31)
            //: break
        }
