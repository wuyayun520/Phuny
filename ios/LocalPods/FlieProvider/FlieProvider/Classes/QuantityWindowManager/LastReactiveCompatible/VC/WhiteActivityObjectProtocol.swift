...
/*: "#777777" :*/
fileprivate let str_labValueData:[Character] = ["#","7","7","7","7","7","7"]

/*: "#333333" :*/
fileprivate let str_textBottomData:String = "#row"
fileprivate let str_equalCustomModelData:String = "imageimageimageimageimage"

/*: "Search" :*/
fileprivate let str_labValue:String = "for errorSearch"

/*: "Details" :*/
fileprivate let str_userReleaseName:String = "else to color error viewDe"
fileprivate let str_promotionData:[Character] = ["t","a","i","l","s"]

/*: "nav_back_black_nor" :*/
fileprivate let str_modelValue:String = "register tapnav_b"
fileprivate let str_colorValue:String = "binfoack"
...
// __CLOSE_PRINT__
//
//  WhiteActivityObjectProtocol.swift
//  AbroadTalking
//
...
class WhiteActivityObjectProtocol: ServiceRecognizerDelegate {
...
//        view.defaultSelectedIndex = currentIndex
    ...
    private lazy var titleArray: [String] = //: return ["Search".localized, "Details".localized]
        ["Search".localized, "Details".localized]
    //: }()

    //: private lazy var dataVC: [TalkingBaseViewController] = {
    private lazy var dataVC: [ServiceRecognizerDelegate] = //: return [HiddenEventReactiveCompatible(), DoingRecognizerDelegate()]
        [HiddenEventReactiveCompatible(), DoingRecognizerDelegate()]
    //: }()
    ...
    private lazy var backButton: UIButton = {
        ...
        let img = UIImage.nearTap(name: (String(str_modelValue.suffix(5)) + "ack_" + str_colorValue.replacingOccurrences(of: "info", with: "l") + "_nor")).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .black
        btn.tintColor = .black
        //: btn.addTarget(self, action: #selector(backButtonClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(giftResign), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension WhiteActivityObjectProtocol: JXSegmentedViewDelegate {
...
extension WhiteActivityObjectProtocol: JXPagingViewDelegate {
...
extension WhiteActivityObjectProtocol {
    /// 返回按钮事件
    //: @objc private func backButtonClick() {
    @objc private func giftResign() {
...
extension WhiteActivityObjectProtocol {
    ...
    private func blockOfMetalSubviews() {
