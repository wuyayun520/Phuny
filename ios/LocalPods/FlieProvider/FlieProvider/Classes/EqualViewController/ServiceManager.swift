...
/*: "&sr=6" :*/
fileprivate let str_hideTitle:[Character] = ["&","s","r","=","6"]
...
enum BeginConvertible: String, CaseIterable {
...
enum AutomaticallyCollection: String {
...
class ServiceManager: NSObject {
    ...
    class func kind(urlType: AutomaticallyCollection) -> String {
        //: var url = IndexStyleAppManager.share.appConfigMode.urlH5Domain
        var url = IndexStyleAppManager.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(IndexStyleAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : IndexStyleAppManager.share.appUserConfigMode.fullRechargePage)
            url.append(IndexStyleAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : IndexStyleAppManager.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(IndexStyleAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : IndexStyleAppManager.share.appUserConfigMode.halfRechargePage)
            url.append(IndexStyleAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : IndexStyleAppManager.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = IndexStyleAppManager.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = IndexStyleAppManager.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            //: url.append(IndexStyleAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(IndexStyleAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
