...
fileprivate let str_fromValue:[UInt8] = [0xb,0xc,0xb,0x16,0x4a,0x1,0xd,0x6,0x7,0x10,0x58,0x4b,0x42,0xa,0x3,0x11,0x42,0xc,0xd,0x16,0x42,0x0,0x7,0x7,0xc,0x42,0xb,0xf,0x12,0xe,0x7,0xf,0x7,0xc,0x16,0x7,0x6]

private func videoGift(array num: UInt8) -> UInt8 {
    return num ^ 98
}

/*: "Enter phone number" :*/
fileprivate let str_formatContent:String = "do input m returnEnter"
fileprivate let str_equalValue:[Character] = ["u","m","b","e","r"]

/*: "Enter Email Address" :*/
fileprivate let str_pathText:String = "class player return cornerEnter "
fileprivate let str_imageBecomeData:String = "manager corner height propertyEmail"

/*: "F4F4F4" :*/
fileprivate let str_modelAppValue:[Character] = ["F","4","F","4","F","4"]

/*: "America(+1)" :*/
fileprivate let str_barFromValue:String = "user button moment var infoAmeri"
fileprivate let str_imageSumLetValue:[Character] = ["1",")"]

/*: "area_code_down_icon" :*/
fileprivate let str_screenName:String = "property var text equal textarea_"
fileprivate let str_labelValue:String = "_downtype local"

/*: "BBBBBB" :*/
fileprivate let str_indexTitle:[Character] = ["B","B","B","B","B","B"]

/*: "btn_field_delete_icon" :*/
fileprivate let str_failName:[Character] = ["b","t","n","_","f","i","e","l","d","_","d","e","l","e","t","e","_","i","c","o"]
fileprivate let str_textData:String = "N"

/*: "Password" :*/
fileprivate let str_leadingData:String = "size coordinate edgePasswo"
fileprivate let str_mBottomName:String = "rlabel"

/*: "CCCCCC" :*/
fileprivate let str_tapLayerTitle:String = "serverserverserver"

/*: "or" :*/
fileprivate let str_loadTheText:String = "otool"

/*: "F5F5F5" :*/
fileprivate let str_viewValue:String = "f5f5f5"

/*: "Next" :*/
fileprivate let str_contentData:String = "break layer info anyNext"

/*: "Login by password" :*/
fileprivate let str_goValue:String = "Logilock name property"
fileprivate let str_shareValue:String = "assworcount"

/*: "Login by OTP" :*/
fileprivate let str_birthName:String = "label mode add labelLogin"
fileprivate let str_subTitle:[Character] = ["T","P"]

/*: "#8C7AFF" :*/
fileprivate let str_requestName:String = "image var type call#8C7AFF"

/*: "Login" :*/
fileprivate let str_dataContent:String = "var make let direction flowLogin"

/*: "Send verification" :*/
fileprivate let str_modelData:[Character] = ["S","e","n","d"," ","v","e","r","i","f","i","c","a","t","i","o","n"]
...
class NumberLoginView: UIView, UITextFieldDelegate {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_fromValue.map{videoGift(array: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = self.loginType == .LoginPhone ? (String(str_formatContent.suffix(5)) + " phone n" + String(str_equalValue)).localized : (String(str_pathText.suffix(6)) + String(str_imageBecomeData.suffix(5)) + " Address").localized
        //: return label
        return label
        //: }()
    }()
    ...
    lazy var areaCodeLabel: UILabel = {
        ...
        label.text = (String(str_barFromValue.suffix(5)) + "ca(+" + String(str_imageSumLetValue))
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaDownImgView: UIImageView = {
        ...
        imageView.image = UIImage.nearTap(name: (String(str_screenName.suffix(5)) + "code" + String(str_labelValue.prefix(5)) + "_icon"))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var phoneInputView: UITextField = {
        ...
        textField.clipsToBounds = true
        //: textField.attributedPlaceholder = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont.loadEnable(type: .Regular, fontSize: 17), NSAttributedString.Key.foregroundColor: UIColor(hex: "BBBBBB")!])
        textField.attributedPlaceholder = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont.loadEnable(type: .Regular, fontSize: 17), NSAttributedString.Key.foregroundColor: UIColor(hex: "BBBBBB")!])
    ...
    private lazy var phoneDeleteBtn: UIButton = {
        ...
        btn.setImage(UIImage.nearTap(name: (String(str_failName) + str_textData.lowercased())), for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var pwdTitleLab: UILabel = {
        ...
        lab.text = (String(str_leadingData.suffix(6)) + str_mBottomName.replacingOccurrences(of: "label", with: "d")).localized
    ...
    private lazy var loginStyleBtn: UIButton = {
        ...
        btn.setTitleColor(UIColor.labelSumervalMedium(), for: .selected)
        //: btn.setTitle("Login by password".localized, for: .normal)
        btn.setTitle((String(str_goValue.prefix(4)) + "n by p" + str_shareValue.replacingOccurrences(of: "count", with: "d")).localized, for: .normal)
        //: btn.setTitle("Login by OTP".localized, for: .selected)
        btn.setTitle((String(str_birthName.suffix(5)) + " by O" + String(str_subTitle)).localized, for: .selected)
        //: btn.addTarget(self, action: #selector(loginStyleButtonClick(sender:)), for: .touchUpInside)
        btn.addTarget(self, action: #selector(bottomWith(sender:)), for: .touchUpInside)
        //: btn.layer.cornerRadius = 25
        btn.layer.cornerRadius = 25
...
extension NumberLoginView {
    ...
    @objc private func bottomWith(sender: UIButton) {
    ...
    func toModel() {
        ...
        commitButton.setTitle((String(str_modelData)).localized, for: .normal)
    }
}
