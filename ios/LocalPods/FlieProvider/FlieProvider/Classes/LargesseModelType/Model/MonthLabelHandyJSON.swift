...
/*: "id" :*/
fileprivate let str_managerData:String = "direction"
...
struct MonthLabelHandyJSON: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: PositionMomentModel?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [PositionHandyJSON]? // 相册
    ...
    var aiExtraInfo = VersionModelType() // AI模型
    //: var vipSkinId = 0
...
struct PositionMomentModel: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [MagnitudeUpMeasurable]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct MagnitudeUpMeasurable: HandyJSON {
...
struct PositionHandyJSON: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func index(compareTo: PositionHandyJSON) -> Bool {
        //: return
        return
...
struct VersionModelType: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
