...
class ColorItemCommentView: UIView {
    ...
    lazy var contentLabel = UILabel().then {
        //: $0.textColor = .white
        $0.textColor = .white
        //: $0.font = .loadEnable(type: .Regular, fontSize: 16)
        $0.font = .loadEnable(type: .Regular, fontSize: 16)
    }
}
...
extension ColorItemCommentView {
...
extension ColorItemCommentView {
    ...
    func addShow(content: String) {
        ...
        if content.isEmptyString {
            ...
            //: let attributes = [.foregroundColor: UIColor.white, .font: UIFont.loadEnable(type: .Regular, fontSize: 16)] as [NSAttributedString.Key: Any]
            let attributes = [.foregroundColor: UIColor.white, .font: UIFont.loadEnable(type: .Regular, fontSize: 16)] as [NSAttributedString.Key: Any]
