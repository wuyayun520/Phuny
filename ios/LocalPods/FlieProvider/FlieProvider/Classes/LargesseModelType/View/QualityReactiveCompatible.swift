...
fileprivate let str_labName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_me_voice_white" :*/
fileprivate let str_viewText:[Character] = ["i","c","o","n","_","m","e"]
fileprivate let str_showName:String = "mobile manager data share_voi"

/*: "btn_auto_write" :*/
fileprivate let str_thanToTitle:String = "btn_autoreference image to self"
fileprivate let str_messageValue:String = "_writeview height cling let image"

/*: "Pending review" :*/
fileprivate let str_retirementValue:String = "self load add errorPendin"
fileprivate let str_countData:String = "read"

/*: "%d″" :*/
fileprivate let str_removeTextName:[Character] = ["%","d","″"]

/*: "get json error" :*/
fileprivate let str_managerModelInContent:String = "with superget "
fileprivate let str_titleText:String = "warningor"
...
class QualityReactiveCompatible: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_labName.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var statusLb: UILabel = {
        ...
        lb.textColor = UIColor.everyUser()
        //: return lb
        return lb
        //: }()
    }()
    ...
    lazy var audioBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.onCornerTo(colors: UIColor.gradient(), size: CGSize(width: 155, height: 35)), for: .normal)
        //: btn.layer.cornerRadius = 17.5
        btn.layer.cornerRadius = 17.5
        //: btn.clipsToBounds = true
        btn.clipsToBounds = true
        //: btn.addTarget(self, action: #selector(recordBtnAction), for: .touchUpInside)
        btn.addTarget(self, action: #selector(listFrom), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    lazy var playIconView: UIImageView = {
        //: let imag = UIImageView.init(image: UIImage.nearTap(name: "icon_me_voice_white"))
        let imag = UIImageView(image: UIImage.nearTap(name: (String(str_viewText) + String(str_showName.suffix(4)) + "ce_white")))
        //: return imag
        return imag
        //: }()
    }()
    ...
    lazy var editBtn: UIButton = {
        //: let btn = UIButton.init()
        let btn = UIButton()
        //: btn.setImage(UIImage.nearTap(name: "btn_auto_write"), for: .normal)
        btn.setImage(UIImage.nearTap(name: (String(str_thanToTitle.prefix(8)) + String(str_messageValue.prefix(6)))), for: .normal)
...
extension QualityReactiveCompatible {
    ...
    func file(model: JumpHandyJSON, row: Int, isLast: Bool) {
        //: index = row
        index = row
        //: islast = isLast
        islast = isLast
        ...
        if model.status == 0 {
            ...
            statusLb.text = (String(str_retirementValue.suffix(6)) + "g revie" + str_countData.replacingOccurrences(of: "read", with: "w")).localized
    ...
    func adjudicate() {
        ...
        do {
            ...
            let url = ResourceEffectTool.default.butterflyEffect(type: .Play_Audio_Wave)
            ...
            printLog(message: (String(str_managerModelInContent.suffix(4)) + "json e" + str_titleText.replacingOccurrences(of: "warning", with: "rr")))
        }
    }
}
