...
fileprivate let str_viewValue:[UInt8] = [0x8b,0x8c,0x8b,0x96,0xca,0x81,0x8d,0x86,0x87,0x90,0xd8,0xcb,0xc2,0x8a,0x83,0x91,0xc2,0x8c,0x8d,0x96,0xc2,0x80,0x87,0x87,0x8c,0xc2,0x8b,0x8f,0x92,0x8e,0x87,0x8f,0x87,0x8c,0x96,0x87,0x86]

private func contentPath(top num: UInt8) -> UInt8 {
    return num ^ 226
}

/*: "Edit Title" :*/
fileprivate let str_labelData:String = "host"
fileprivate let str_userFrameName:String = "dit image let let"

/*: "0/ :*/
fileprivate let str_pathData:String = "of/"

/*: "Finish" :*/
fileprivate let str_fromValue:[Character] = ["F","i","n","i","s","h"]

/*: "btn_delete" :*/
fileprivate let str_scopeTitle:String = "self tab pairbtn_"
fileprivate let str_centerName:String = "shoote"

/*: / :*/
fileprivate let str_readValue:String = "context"

/*: "\n" :*/
fileprivate let str_priceViewData:String = "\n"
...
class EqualView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        self.masterConstraint()
        //: let tapGesture = UITapGestureRecognizer(target: self, action: #selector(dismissView))
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(timeConversation))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_viewValue.map{contentPath(top: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var titleLabel: UILabel = {
        ...
        lab.text = (str_labelData.replacingOccurrences(of: "host", with: "E") + String(str_userFrameName.prefix(4)) + "Title").localized
    ...
    lazy var inputTView: RowHasDelegate = {
    ...
    private lazy var finishBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(observerClick), for: .touchUpInside)
        //: btn.isEnabled = false
        btn.isEnabled = false
        //: return btn
        return btn
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.setImage(UIImage.nearTap(name: (String(str_scopeTitle.suffix(4)) + "dele" + str_centerName.replacingOccurrences(of: "shoot", with: "t"))), for: .normal)
...
extension EqualView {
    ...
    @objc func timeConversation() {}

    //: @objc func finishBtnClick() {
    @objc func observerClick() {
        //: dismiss()
        componentOf()
        //: if textUpload != nil {
        if textUpload != nil {
...
extension EqualView: UITextViewDelegate {
    ...
    public func textViewDidChange(_ textView: UITextView) {
        ...
        if textView.text.count > lengthLimit {
            ...
            if textNum > lengthLimit && lengthLimit > 0 {
                ...
                textView.text = mottle(index: lengthLimit, text: textContent)
            }
        }
    ...
    private func mottle(index: Int, text: String) -> String {
        //: if text.count <= index {
        if text.count <= index {
            //: return text
            return text
