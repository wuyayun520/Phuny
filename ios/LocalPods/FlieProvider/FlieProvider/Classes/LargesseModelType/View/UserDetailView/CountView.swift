...
fileprivate let str_resultData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_dynamic_stop_nor" :*/
fileprivate let str_makeTitle:String = "btn_text button self error"
fileprivate let str_backgroundName:String = "list pushmic_s"
...
class CountView: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_resultData.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var bgImgView: UIImageView = {
        ...
        imgV.image = UIImage.visualImageBanner()
    ...
    private lazy var playimageView: UIImageView = {
        //: let imag = UIImageView(image: UIImage.nearTap(name: "btn_dynamic_stop_nor"))
        let imag = UIImageView(image: UIImage.nearTap(name: (String(str_makeTitle.prefix(4)) + "dyna" + String(str_backgroundName.suffix(5)) + "top_nor")))
        //: return imag
        return imag
        //: }()
    }()
...
extension CountView {
    ...
    func rowDismiss(videoUrl: String, imgUrl: String) {
        //: self.videoUrl = videoUrl
        self.videoUrl = videoUrl
        //: self.coverView.setUrlImage(urlStr: imgUrl)
        self.coverView.underPause(urlStr: imgUrl)
    }
    ...
    func golferTag() {
        ...
        self.player.seedWithoutForefront(url: videoUrl, view: self.coverView)
...
extension CountView: ContextReactiveCompatible {
