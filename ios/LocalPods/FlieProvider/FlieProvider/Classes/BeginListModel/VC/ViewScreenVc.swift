...
class ViewScreenVc: ServiceRecognizerDelegate {
    ...
    lazy var topView: MakeServerReactiveCompatible = {
        //: let view = TalkingMomentPhotosTopView(frame: CGRect.zero, type: myType ?? .normal)
        let view = MakeServerReactiveCompatible(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: AccountingDataView = {
    ...
    lazy var usePhotoView: ContentInfoView = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = ContentInfoView(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension ViewScreenVc {
    //: func crushBtnTool(modle: TalkingMomentModel) {
    func saveShow(modle: TextTransformable) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==IndexStyleAppManager.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == IndexStyleAppManager.share.loginUserMode.sex
        }
