...
fileprivate let str_countData:[UInt8] = [0xaf,0xa8,0xaf,0xb2,0xee,0xa5,0xa9,0xa2,0xa3,0xb4,0xfc,0xef,0xe6,0xae,0xa7,0xb5,0xe6,0xa8,0xa9,0xb2,0xe6,0xa4,0xa3,0xa3,0xa8,0xe6,0xaf,0xab,0xb6,0xaa,0xa3,0xab,0xa3,0xa8,0xb2,0xa3,0xa2]

private func statusRoom(normal num: UInt8) -> UInt8 {
    return num ^ 198
}

/*: "icon_home_v" :*/
fileprivate let str_quitPlayerContent:String = "icon_mini min icon observer"
fileprivate let str_viewName:String = "data value model return valuehome_v"

/*: "icon_lounge" :*/
fileprivate let str_indexListenName:[Character] = ["i","c","o","n","_","l","o","u","n","g"]
fileprivate let str_giftName:[Character] = ["e"]

/*: "#AAAAAA" :*/
fileprivate let str_reButtonContent:[Character] = ["#","A","A","A","A","A"]
fileprivate let str_greetData:[Character] = ["A"]

/*: "icon_moment_nor_report" :*/
fileprivate let str_imageValue:[Character] = ["i","c","o","n","_","m","o","m","e","n","t","_","n","o","r","_","r"]
fileprivate let str_mainValue:String = "erequestrt"

/*: "img_me_edit_photo_default" :*/
fileprivate let str_errorName:String = "img_meif tag var"
fileprivate let str_wrapValue:String = "remove invite equalt_ph"
fileprivate let str_colorData:String = "data constraint beyond observer varoto_"

/*: "icon_home_boy" :*/
fileprivate let str_labelName:String = "managerc"
fileprivate let str_topValue:String = "to pic model color leton_ho"

/*: "icon_home_girl" :*/
fileprivate let str_layerData:String = "icstatus"
fileprivate let str_dataName:String = "e_girlview center tap view"

/*: "   " :*/
fileprivate let str_pathValue:[Character] = [" "," "," "]

/*: "level_" :*/
fileprivate let str_propertyData:[Character] = ["l","e","v","e","l","_"]
...
class PositionThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_countData.map{statusRoom(normal: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var cardImgView: UIImageView = {
        ...
        img.image = UIImage.nearTap(name: (String(str_quitPlayerContent.prefix(5)) + String(str_viewName.suffix(6))))
    ...
    lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.nearTap(name: (String(str_indexListenName) + String(str_giftName)))
        //: self.addSubview(img)
        self.addSubview(img)
        //: return img
        return img
    ...
    lazy var BlockBtn: UIButton = {
        ...
        btn.setImage(UIImage.nearTap(name: (String(str_imageValue) + str_mainValue.replacingOccurrences(of: "request", with: "po"))), for: .normal)
        //: btn.imageView?.contentMode = .scaleAspectFill
        btn.imageView?.contentMode = .scaleAspectFill
...
extension PositionThen {
    ...
    @objc func pushOf(gestureRecongnizer: UIGestureRecognizer) {
    ...
    @objc func videoClick() {
        ...
        let reportView = ValueDataSource(frame: UIScreen.main.bounds, type: .reportCommentType, rId: cid)
        //: reportView.showReportViewIn(view: OverdoReactiveCompatible.getWindow())
        reportView.thirdView(view: OverdoReactiveCompatible.outMax())
    }
}
...
extension PositionThen {
    ...
    func showWillModel(model: SequenceHandyJSON) {
        //: cid = model.cid ?? ""
        cid = model.cid ?? ""
        //: uid = model.uid ?? ""
        uid = model.uid ?? ""
        //: iconBtn.setUrlImage(urlStr: model.headPic ?? "", placeImg: UIImage.nearTap(name: "img_me_edit_photo_default"))
        iconBtn.net(urlStr: model.headPic ?? "", placeImg: UIImage.nearTap(name: (String(str_errorName.prefix(6)) + "_edi" + String(str_wrapValue.suffix(4)) + String(str_colorData.suffix(4)) + "default")))
        ...
        nameLabel.textColor = model.loungePlus ? .beyondEnd() : .frontColor()
        ...
        case ColorExpressionConvertible.male.rawValue:
            ...
            sexBtn.setBackgroundImage(UIImage.nearTap(name: (str_labelName.replacingOccurrences(of: "manager", with: "i") + String(str_topValue.suffix(5)) + "me_boy")), for: .normal)
        //: break
        ...
        case ColorExpressionConvertible.female.rawValue:
            ...
            sexBtn.setBackgroundImage(UIImage.nearTap(name: (str_layerData.replacingOccurrences(of: "status", with: "on") + "_hom" + String(str_dataName.prefix(6)))), for: .normal)
        //: break
        //: default:
        default:
            //: break
        ...
        contentLB.text = model.content
        //: BlockBtn.isHidden = IndexStyleAppManager.share.loginUserMode.userID == model.uid
        BlockBtn.isHidden = IndexStyleAppManager.share.loginUserMode.userID == model.uid
    }
}
...
extension PositionThen {
    ...
    private func setupBlockSubviews() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(tablePost))
        //: self.addGestureRecognizer(tap)
        self.addGestureRecognizer(tap)

        //: let longPress = UILongPressGestureRecognizer(target: self, action: #selector(onLongTapCell(gestureRecongnizer:)))
        let longPress = UILongPressGestureRecognizer(target: self, action: #selector(pushOf(gestureRecongnizer:)))
