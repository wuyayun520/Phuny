...
fileprivate let str_toName:[UInt8] = [0x66,0x6b,0x66,0x71,0x25,0x60,0x6c,0x61,0x62,0x6f,0x37,0x26,0x1d,0x65,0x5e,0x70,0x1d,0x6b,0x6c,0x71,0x1d,0x5f,0x62,0x62,0x6b,0x1d,0x66,0x6a,0x6d,0x69,0x62,0x6a,0x62,0x6b,0x71,0x62,0x61]

fileprivate func openOfCell(license num: UInt8) -> UInt8 {
    let value = Int(num) + 3
    if value > 255 {
...
class KeyProgressView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_toName.map{openOfCell(license: $0)}, encoding: .utf8)!)
    }
