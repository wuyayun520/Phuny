...
fileprivate let str_viewGroupData:[UInt8] = [0x8,0xf,0x8,0x15,0x49,0x2,0xe,0x5,0x4,0x13,0x5b,0x48,0x41,0x9,0x0,0x12,0x41,0xf,0xe,0x15,0x41,0x3,0x4,0x4,0xf,0x41,0x8,0xc,0x11,0xd,0x4,0xc,0x4,0xf,0x15,0x4,0x5]

/*: "icon_chat_start" :*/
fileprivate let str_addTitle:[Character] = ["i","c","o","n","_","c","h","a","t","_","s","t","a","r"]
fileprivate let str_ofCellDeadlineData:String = "bar"

/*: "#752FE9" :*/
fileprivate let str_enableName:String = "#observer"
fileprivate let str_hideTitle:String = "self view render52FE9"

/*: "#F5F5F5" :*/
fileprivate let str_mainTitle:String = "#F5F5Fview up log type level"
fileprivate let str_viewTitle:[Character] = ["5"]

/*: "@ :*/
fileprivate let str_equalName:[Character] = ["@"]

/*: "btn_feed_dianzan_nor" :*/
fileprivate let str_picLoadValue:[UInt8] = [0xee,0xf8,0xe2,0xd3,0xea,0xe9,0xe9,0xe8,0xd3,0xe8,0xe5,0xed,0xe2,0xf6,0xed,0xe2,0xd3,0xe2,0xe3,0xfe]

/*: "btn_feed_reply_nor" :*/
fileprivate let str_sessionValue:[Character] = ["b","t","n","_","f","e","e","d","_","r","e","p","l"]
fileprivate let str_textViewInputName:[Character] = ["y","_","n","o","r"]
...
class WhiteAddFeedCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_viewGroupData.map{$0^97}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.nearTap(name: (String(str_addTitle) + str_ofCellDeadlineData.replacingOccurrences(of: "bar", with: "t")))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
...
extension WhiteAddFeedCell {
    /// 刷新cell
    //: func refreshCell(_ model: TalkingRemindListModel) {
    func compartmentCell(_ model: BeginListModel) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.cling(urlStr: model.headPic, placeImg: UIImage.visualImageBanner())
        ...
        previewImgView.underPause(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: str_picLoadValue.map{$0^140}, encoding: .utf8)! : (String(str_sessionValue) + String(str_textViewInputName))
        //: statusIcon.image = UIImage.nearTap(name: typeImgStr)
        statusIcon.image = UIImage.nearTap(name: typeImgStr)
...
extension WhiteAddFeedCell {
    ...
    private func insertRequest() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((consLet_errorDeviceHeightData - 128) / 2)
        }
