...
public class ItemSafeArray<Element> {
...
public extension ItemSafeArray {
    //: var first: Element? {
    var first: Element? {
        //: var result: Element?
        var result: Element?
...
public extension ItemSafeArray {
    ...
    func filter(isIncluded: @escaping (Element)->Bool) ->ItemSafeArray<Element> {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        ...
        return ItemSafeArray(array: result)
    }
    ...
    func sorted(by areInIncreasingOrder: (Element, Element)->Bool)->ItemSafeArray<Element> {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        //: let result = array.sorted(by: areInIncreasingOrder)
        let result = array.sorted(by: areInIncreasingOrder)
        //: let newArray = ThreadSafeArray<Element>(array: result)
        let newArray = ItemSafeArray<Element>(array: result)
        //: pthread_rwlock_unlock(&lock)
        pthread_rwlock_unlock(&lock)
        //: return newArray
        return newArray
...
public extension ItemSafeArray where Element: Equatable {
...
public extension ItemSafeArray {
    ...
    static func +=(left: inout ItemSafeArray, right: Element) {
        //: left.append(right)
        left.append(right)
    }
