...
class HalfLabel: UILabel {
    ...
    //: private func setup() {
    private func adjacentShow() {
        //: translatesAutoresizingMaskIntoConstraints = false
        translatesAutoresizingMaskIntoConstraints = false
        //: layer.backgroundColor = UIColor.msgTipsColor().cgColor
        layer.backgroundColor = UIColor.everyUser().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.loadEnable(type: .Medium, fontSize: 11)
        font = UIFont.loadEnable(type: .Medium, fontSize: 11)
...
class IntervalDataReactiveCompatible: UILabel {
    ...
    func setMenuMastheadUp(isTop:Bool) {
        //: if isTop {
        if isTop {
