...
fileprivate let str_kitContent:[Character] = ["b","t","n","_","m","e","_","b","a","c","k","_","c","o","n","t","i"]
fileprivate let str_modelPostValue:String = "nustart"

/*: "init(coder:) has not been implemented" :*/
fileprivate let str_videoCenterName:[UInt8] = [0x2d,0x2a,0x2d,0x30,0x6c,0x27,0x2b,0x20,0x21,0x36,0x7e,0x6d,0x64,0x2c,0x25,0x37,0x64,0x2a,0x2b,0x30,0x64,0x26,0x21,0x21,0x2a,0x64,0x2d,0x29,0x34,0x28,0x21,0x29,0x21,0x2a,0x30,0x21,0x20]

private func statuteTitle(manager num: UInt8) -> UInt8 {
    return num ^ 68
}
...
class PermitThen: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(moveWith), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(preemptionLikeClick), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: ResourceAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(str_kitContent) + str_modelPostValue.replacingOccurrences(of: "start", with: "e"))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_videoCenterName.map{statuteTitle(manager: $0)}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func due(title: String, isTouch: Bool) {
