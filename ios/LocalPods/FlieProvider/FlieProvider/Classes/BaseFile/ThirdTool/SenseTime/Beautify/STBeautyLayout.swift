...
class STBeautyLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        page = max(page, 1)
        layoutContentSize = CGSize(width: Int(consLet_errorDeviceHeightData) * page, height: 2*GiftItemHeight)
    }
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        let itemWidth = 76
        let x = page * Int(consLet_errorDeviceHeightData) + pageCol * (itemWidth )
