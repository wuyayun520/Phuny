...
enum VersionViewEquatable: String {
    //: case AppleLogin
...
/// 性别
//: enum Gender: String {
enum ColorExpressionConvertible: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum QualityNameLiteral: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum PositionStatusPriorityTarget: Int {
    //: case isOnGoing = 0
...
enum ContextGrantWidthCount: Int {
    //: case unknown    = 0
    case unknown = 0
    //: case social     = 1
    case social = 1 // 社交礼物
...
@objc public enum CountensityNetworkStatus: Int {
    //: case Unavailable = 0
...
enum TitleCaseIterable: CaseIterable {
...
enum SumHiddenSubscriptType: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2
